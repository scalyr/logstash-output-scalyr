...
2. Install the gem into a Logstash installation, run `/usr/share/logstash/bin/logstash-plugin install logstash-output-scalyr-1.0.0-alpha.gem` or follow the latest official instructions on working with plugins from Logstash.
